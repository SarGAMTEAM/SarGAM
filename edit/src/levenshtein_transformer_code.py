...
@register_model("levenshtein_transformer_code")
class LevenshteinTransformerCodeModel(FairseqNATModel):
    @property
...
@register_model_architecture("levenshtein_transformer_code", "levenshtein_transformer_code")
...
@register_model_architecture(
    "levenshtein_transformer_code", "levenshtein_transformer_code_wmt_en_de"
)
...
@register_model_architecture(
    "levenshtein_transformer_code", "levenshtein_transformer_code_vaswani_wmt_en_de_big"
)
...
@register_model_architecture(
    "levenshtein_transformer_code", "levenshtein_transformer_code_wmt_en_de_big"
)
