...
class IterativeRefinementGeneratorLevCode(object):
    def __init__(
        self,
        tgt_dict,
        models=None,
    ...
    def generate(self, models, sample, prefix_tokens=None, constraints=None):
        ...
        if self.init_tokens is not None:
            initial_tokens = sample[self.init_tokens]
            # print(initial_tokens)

        # initialize
        encoder_out = model.forward_encoder([src_tokens, src_lengths])
        prev_decoder_out = model.initialize_output_tokens(encoder_out, src_tokens, initial_tokens)
